...
export const THEMES = {
  ...
  music: {
    ...
    messages: [
      ...
      ['', 'AFTER SILENCE', 'THAT WHICH', 'COMES NEAREST', 'TO EXPRESSING', 'THE UNSAYABLE', '- ALDOUS', 'HUXLEY'],
  ...
  contemplative: {
    ...
    messages: [
      ...
      ['', 'THE SOUL IS', 'NOT IN THE', 'BODY BUT', 'THE BODY IS', 'IN THE SOUL', '', '- MEISTER', 'ECKHART'],
