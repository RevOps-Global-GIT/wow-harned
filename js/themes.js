...
export const THEMES = {
  eastern: {
    ...
    messages: [
      ...
      ['', 'DO NOT DWELL', 'IN THE PAST', 'DO NOT DREAM', 'OF THE FUTURE', 'CONCENTRATE', 'ON THE NOW', ''],
    ]
  },
  philosophy: {
    label: 'Philosophy',
  ...
  humor: {
    label: 'Humor',
    messages: [
      ['', 'I TOLD MY', 'WIFI WE NEED', 'TO TALK .', 'IT FELT LIKE', 'THE CONNECTION', 'WAS LOST', ''],
      ...
      ['', 'LIGHT TRAVELS', 'FASTER THAN', 'SOUND THATS', 'WHY SOME', 'SEEM BRIGHT', '', ''],
      ...
      ['', 'BEHIND EVERY', 'GREAT MAN IS', 'A WOMAN', 'ROLLING', 'HER EYES', '', '- CARLIN'],
    ]
  },
  nature: {
    label: 'Nature',
  ...
  positivity: {
    ...
    messages: [
      ...
      ['', 'LET YOUR', 'LIGHT SHINE', 'SO BRIGHTLY', 'THAT OTHERS', 'CAN SEE', 'THEIR WAY', ''],
  ...
  music: {
    ...
    messages: [
      ...
      ['', 'AFTER', 'SILENCE THAT', 'WHICH COMES', 'NEAREST TO', 'THE', 'INEXPRESSIBLE', ''],
