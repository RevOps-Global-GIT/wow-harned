...
export const THEMES = {
  eastern: {
    ...
    messages: [
      ...
      ['', 'SITTING', 'QUIETLY DOING', 'NOTHING', 'SPRING COMES', 'AND THE GRASS', 'GROWS', '- BASHO'],
      ...
      ['', 'WHAT THE', 'SUPERIOR MAN', 'SEEKS IS IN', 'HIMSELF', '', '- CONFUCIUS', ''],
      ['', 'DO NOT DWELL', 'IN THE PAST', 'DO NOT DREAM', 'OF THE FUTURE', 'CONCENTRATE', 'ON THE NOW', '- BUDDHA'],
      ['', 'WALK AS IF', 'YOU ARE', 'KISSING THE', 'EARTH WITH', 'YOUR FEET', '', '- THICH NHAT H'],
      ['', 'SMILE', 'BREATHE AND', 'GO SLOWLY', '', '', '- THICH NHAT H', ''],
      ['', 'THE PRESENT', 'MOMENT IS', 'FILLED WITH', 'JOY AND', 'HAPPINESS', '', '- THICH NHAT H'],
      ['', 'BECAUSE YOU', 'ARE ALIVE', 'EVERYTHING IS', 'POSSIBLE', '', '- THICH NHAT H', ''],
      ['', 'WHEN ANOTHER', 'PERSON MAKES', 'YOU SUFFER IT', 'IS BECAUSE HE', 'SUFFERS TOO', '', '- THICH NHAT H'],
      ['', 'DRINK YOUR', 'TEA SLOWLY', 'AND REVERENTLY', 'AS IF IT IS', 'THE AXIS OF', 'THE WORLD', '- THICH NHAT H'],
      ['', 'FEELINGS COME', 'AND GO LIKE', 'CLOUDS IN A', 'WINDY SKY', '', '- THICH NHAT H', ''],
      ['', 'SOMETIMES', 'YOUR JOY IS', 'THE SOURCE OF', 'YOUR SMILE', 'AND SOMETIMES', 'YOUR SMILE', '- THICH NHAT H'],
    ]
  },
  philosophy: {
    label: 'Philosophy',
  ...
  humor: {
    ...
    messages: [
      ...
      ['', 'IF AT FIRST', 'YOU DONT', 'SUCCEED THEN', 'SKYDIVING IS', 'NOT FOR YOU', '', '- STEVEN WRIGHT'],
      ['', 'DO NOT TAKE', 'LIFE TOO', 'SERIOUSLY', 'YOU WILL NOT', 'GET OUT ALIVE', '', '- ELBERT H'],
      ['', 'BEHIND EVERY', 'GREAT MAN IS', 'A WOMAN', 'ROLLING', 'HER EYES', '', '- JIM CARREY'],
      ['', 'THE ONLY', 'MYSTERY IN', 'LIFE IS WHY', 'KAMIKAZE PILOTS', 'WORE HELMETS', '', '- AL MCGUIRE'],
      ['', 'I REFUSE TO', 'JOIN ANY CLUB', 'THAT WOULD', 'HAVE ME AS', 'A MEMBER', '', '- GROUCHO MARX'],
      ['', 'A DAY WITHOUT', 'LAUGHTER IS', 'A DAY WASTED', '', '', '', '- CHARLIE C'],
      ['', 'THE BEST THING', 'ABOUT THE', 'FUTURE IS IT', 'COMES ONE DAY', 'AT A TIME', '', '- ABE LINCOLN'],
  ...
  nature: {
    ...
    messages: [
      ...
      ['', 'STUDY NATURE', 'LOVE NATURE', 'STAY CLOSE', 'TO NATURE', '', '- F L WRIGHT', ''],
      ['', 'NATURE DOES', 'NOT HURRY', 'YET', 'EVERYTHING IS', 'ACCOMPLISHED', '', '- LAO TZU'],
      ['', 'THE OCEAN', 'STIRS THE', 'HEART AND', 'INSPIRES THE', 'IMAGINATION', '', '- WYLAND'],
      ['', 'HEAVEN IS', 'UNDER OUR', 'FEET AS WELL', 'AS OVER', 'OUR HEADS', '', '- THOREAU'],
      ['', 'EVERY FLOWER', 'IS A SOUL', 'BLOSSOMING', 'IN NATURE', '', '- NERVAL', ''],
  ...
  wisdom: {
    ...
    messages: [
      ...
      ['', 'THE BEST TIME', 'TO PLANT A', 'TREE WAS 20', 'YEARS AGO .', 'THE NEXT BEST', 'IS NOW', '- CHINESE PROV'],
  ...
  positivity: {
    label: 'Positivity',
    messages: [
      ['', 'EVERY DAY IS', 'A NEW', 'BEGINNING', 'TAKE A DEEP', 'BREATH AND', 'START AGAIN', '- T S ELIOT'],
      ['', '', 'YOU ARE', 'ENOUGH JUST', 'AS YOU ARE', '', '- MEGHAN', 'MARKLE'],
      ['', 'BELIEVE YOU', 'CAN AND YOU', 'ARE HALFWAY', 'THERE', '', '- TEDDY R', ''],
      ['', 'WHEREVER', 'YOU GO', 'GO WITH ALL', 'YOUR HEART', '', '- CONFUCIUS', ''],
      ['', 'HAPPINESS IS', 'NOT SOMETHING', 'READY MADE', 'IT COMES FROM', 'YOUR ACTIONS', '', '- DALAI LAMA'],
      ['', 'BE YOURSELF .', 'EVERYONE ELSE', 'IS ALREADY', 'TAKEN', '', '- OSCAR WILDE', ''],
      ['', 'KEEP YOUR', 'FACE ALWAYS', 'TOWARD THE', 'SUNSHINE AND', 'SHADOWS FALL', 'BEHIND', '- WALT WHITMAN'],
      ...
      ['', 'STARS CANT', 'SHINE', 'WITHOUT', 'DARKNESS', '', '', '- D H SIDHU'],
      ['', 'YOU ARE', 'BRAVER THAN', 'YOU BELIEVE', 'STRONGER', 'THAN YOU SEEM', '', '- A A MILNE'],
      ['', 'LET YOUR', 'LIGHT SHINE', 'SO BRIGHTLY', 'THAT OTHERS', 'CAN SEE', 'THEIR WAY', '- WHITMAN'],
  ...
  art: {
    ...
    messages: [
      ...
      ['', 'EVERY CHILD', 'IS AN ARTIST', 'THE PROBLEM', 'IS STAYING', 'ONE', '', '- PICASSO'],
      ['', 'ART IS THE', 'LIE THAT', 'ENABLES US TO', 'REALIZE', 'TRUTH', '', '- PICASSO'],
      ['', 'THE EARTH', 'WITHOUT ART', 'IS JUST', 'EH', '', '', '- DEMETRI M'],
      ...
      ['', 'PAINTING IS', 'POETRY THAT', 'IS SEEN', 'RATHER THAN', 'FELT', '', '- DA VINCI'],
  ...
  creativity: {
    ...
    messages: [
      ...
      ['', 'DONT THINK .', 'THINKING IS', 'THE ENEMY OF', 'CREATIVITY', '', '- BRADBURY', ''],
      ['', 'CLEAN OUT A', 'CORNER OF', 'YOUR MIND', 'AND', 'CREATIVITY', 'WILL FILL IT', '- DEE HOCK'],
      ['', 'MAKE VISIBLE', 'WHAT WITHOUT', 'YOU MIGHT', 'NEVER HAVE', 'BEEN SEEN', '', '- BRESSON'],
      ['', 'INSPIRATION', 'EXISTS BUT', 'IT HAS TO', 'FIND YOU', 'WORKING', '', '- PICASSO'],
      ['', 'TO CREATE', 'ONE MUST', 'FIRST', 'QUESTION', 'EVERYTHING', '', '- EILEEN GRAY'],
      ['', 'THE DESIRE', 'TO CREATE IS', 'ONE OF THE', 'DEEPEST', 'YEARNINGS', '', '- DIETER RAMS'],
  ...
  harned: {
    ...
    messages: [
      ...
      ['', 'I THINK', 'THEREFORE', 'I AM', '', '- ZACH HARNED', '', ''],
      ['', 'THAT WHICH', 'DOES NOT KILL', 'US MAKES US', 'STRONGER', '', '- ZACH HARNED', ''],
      ['', 'THE ONLY THING', 'WE HAVE TO', 'FEAR IS', 'FEAR ITSELF', '', '- ZACH HARNED', ''],
      ['', 'TO INFINITY', 'AND BEYOND', '', '', '- ZACH HARNED', '', ''],
      ['', 'STAY HUNGRY', 'STAY FOOLISH', '', '', '- ZACH HARNED', '', ''],

      // Fred slightly butchers the classics
      ['', 'THE EARLY BIRD', 'GETS THE', 'PANCAKES OR', 'WHATEVER', '', '- FRED HARNED', ''],
      ['', 'A PENNY SAVED', 'IS ... STILL', 'JUST A PENNY', '', '', '- FRED HARNED', ''],
      ['', 'GIVE A MAN A', 'FISH AND HE', 'EATS FOR A', 'DAY . MAYBE', 'TWO TOPS', '', '- FRED HARNED'],
      ['', 'WHEN LIFE', 'GIVES YOU', 'LEMONS MAKE', '... WHAT WAS', 'IT AGAIN', '', '- FRED HARNED'],
      ['', 'ROME WASNT', 'BUILT IN A DAY', 'BUT THEY WERE', 'PROBABLY', 'CLOSE', '', '- FRED HARNED'],
      ...
      // Ethan (baseball kid)
      ['', 'YOU MISS 100', 'PERCENT OF THE', 'SHOTS YOU', 'DONT TAKE', '', '- ETHAN HARNED', ''],
      ['', 'ALL I NEED', 'IS BASEBALL', 'AND BASEBALL', 'ACCESSORIES', '', '- ETHAN HARNED', ''],
