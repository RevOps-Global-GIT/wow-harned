...
export const THEMES = {
  eastern: {
    ...
    messages: [
      ...
      ['', 'WHEN ANOTHER', 'PERSON MAKES', 'YOU SUFFER IT', 'IS BECAUSE HE', 'SUFFERS TOO', '- THICH NHAT', 'HANH'],
      ['', 'DRINK YOUR', 'TEA SLOWLY', 'AS IF IT IS', 'THE AXIS OF', 'THE WORLD', '- THICH NHAT', 'HANH'],
      ['', 'FEELINGS COME', 'AND GO LIKE', 'CLOUDS IN A', 'WINDY SKY', '- THICH NHAT', 'HANH', ''],
      ['', 'SOMETIMES', 'YOUR JOY IS', 'THE SOURCE OF', 'YOUR SMILE', 'AND SOMETIMES', '- THICH NHAT', 'HANH'],
    ]
  },
  philosophy: {
    label: 'Philosophy',
